...
export default function Home() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3002/officials")
      .then((response) => {
    ...
    axios
      .get("http://localhost:3002/residents/total")
      .then((response) => {
      ...
      >
        ...
        >
          ...
          <button
            style={buttonStyle}
            type="button"
            onClick={() => handleLoginClick("Resident")}
          >
            <i className="material-icons" style={iconStyle}>
              group
            </i>
          ...
          <button
            style={buttonStyle}
            type="button"
            onClick={() => handleLoginClick("Documents")}
          >
            <i className="material-icons" style={iconStyle}>
              description
            </i>
          ...
          <button
            style={buttonStyle}
            type="button"
            onClick={() => handleLoginClick("OfficialUnit")}
          >
            <i className="material-icons" style={iconStyle}>
              recent_actors
            </i>
          ...
          <button
            style={buttonStyle}
            type="button"
            onClick={() => handleLoginClick("LogInPage")}
          >
            <i className="material-icons" style={iconStyle}>
              exit_to_app
            </i>
      ...
      >
        ...
        >
              ...
              >
                ...
                <tbody>
                  {officialList.map((val, key) => (
                    <tr key={key}>
                      <td style={{ textAlign: "center", padding: "1.5em", fontSize:'18px' }}>
                        {val.name}
                      </td>
                      <td style={{ textAlign: "center", padding: "1.5em", fontSize:'18px' }}>
                        {val.position}
          ...
          >
            ...
            >
              <div style={boxStyle}>
                <i className="material-icons" style={boxIconStyle}>
                  people
                </i>
