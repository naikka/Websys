          ...
          <table className="striped" style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead style={{ position: 'sticky', top: '0', backgroundColor: 'white', zIndex: '1' }}>
              <tr>
                ...
                <th style={{ width: '16%', textAlign: 'center', borderBottom: '2px solid #ddd', color:'#1976d2' }}>Marital Status</th>
                <th style={{ width: '16%', textAlign: 'center', borderBottom: '2px solid #ddd', color:'#1976d2' }}>Edit/Delete</th>
              </tr>
            </thead>
            <tbody>
              {residentList.map((val, key) => (
                <tr key={key}>
                  ...
                  <td style={{ textAlign: 'center' }}>
                    <Link to="/updateResident"><button className="btn-flat">
